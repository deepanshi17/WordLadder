...
public class SampleTest {
	...
	@Test
	public void testDiffisOne() {
		String word1 = "question";
		String word2 = "buestion";
		assertTrue(Adjacency.diffIsOne(word1, word2) == differByOne(word1, word2));
	...
	public void parseTest() {
		...
		ArrayList<String> response = Main.parse(kb);
		assertTrue(response.get(0).equals("hello"));
		assertTrue(response.get(1).equals("words"));
	...
	*/
	...
	@Test(timeout = 30000)
	public void testBFSlonger() {
		ArrayList<String> res = Main.getWordLadderBFS("money", "stone");
	...
	public void testDFS3() {
		ArrayList<String> res = Main.getWordLadderDFS("money", "stone");
		if (res != null) {
			HashSet<String> set = new HashSet<String>(res);
			assertEquals(set.size(), res.size());
		}
	...
	/** Word exists, but no Word Ladder **/
	@Test(timeout = 30000)
	public void testBFS3() {
		ArrayList<String> res = Main.getWordLadderBFS("zebra", "drawl");
		if (res != null) {
			HashSet<String> set = new HashSet<String>(res);
			assertEquals(set.size(), res.size());
		}
	...
	public void testBFS4() {
		ArrayList<String> res = Main.getWordLadderBFS("blues", "pinks");
	...
	public void testBFS5() {
		ArrayList<String> res = Main.getWordLadderBFS("brews", "skies");
